...
namespace AmplifyShaderEditor
{
	public sealed class ShaderEditorModeWindow : MenuParent
	{
		...
		public void Draw( Rect _graphArea, Vector2 mousePos, Shader currentShader, Material currentMaterial, float usableArea, float leftPos, float rightPos )
		{
			...
			{
				m_init = false;
				GUIStyle shaderModeTitle = UIUtils.CustomStyle( CustomStyle.ShaderModeTitle );
				GUIStyle shaderModeNoShader = UIUtils.CustomStyle( CustomStyle.ShaderModeNoShader );
				GUIStyle materialModeTitle = UIUtils.CustomStyle( CustomStyle.MaterialModeTitle );
				GUIStyle shaderNoMaterialModeTitle = UIUtils.CustomStyle( CustomStyle.ShaderNoMaterialModeTitle );
			...
			//Shader Mode
			{
				GUIStyle style = UIUtils.CustomStyle( currentShader == null ? CustomStyle.ShaderModeNoShader : CustomStyle.ShaderModeTitle );
			...
			// Material Mode
			{
				GUIStyle style = UIUtils.CustomStyle( currentMaterial == null ? CustomStyle.ShaderNoMaterialModeTitle : CustomStyle.MaterialModeTitle );
