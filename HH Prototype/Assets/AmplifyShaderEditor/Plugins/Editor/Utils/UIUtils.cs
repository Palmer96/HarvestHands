...
namespace AmplifyShaderEditor
{
	...
	public class UIUtils
	{
		...
		private static Dictionary<string, string> m_exampleShaderIDs = new Dictionary<string, string>() {{"DissolveBurn", "94f20be2bc537ca40a2d1a87c19fe6d9" },
																										{"MourEnvironmentGradient","f201ea4f46e498147a15babbb4df8273" },
																										{"AnimatedFire","a4129ef62fbb79d4dbbea2bad66b93c3" },
																										{"BurnEffect","8b05d49618da25843a494fa0753b4fab" },
																										{"CubemapReflections","3563bc1308b7c254bbef2821193d91d5" },
																										{"DitheringFade","11bef2a90eac9c049b60ad0a773814df" },
																										{"NormalExtrusion","c41a68762c63e9940a934bd0a4bffbf7" },
																										{"MatcapSample","d9bcb6584ed2b0248a7f67e9a77e808e" },
																										{"ParallaxMappingIterations","9cfe017c59b6a344d91f3148c4f8bca8" },
																										{"SandPOM","5aee3908d6fc5d647b56474239e43e9b" },
																										{"ParallaxWindow","c2c82a368002e744b8352f9a84e6d7e5" },
																										{"LocalPosCutoff","b7398052d9a97ac4f9b0758ca055043c" },
																										{"ImprovedReadFromAtlasTiled","ca3935d65ba92714d89677a8f3c4d101" },
																										{"ReadFromAtlasTiled","6c2c8eaf5bd51e74faa83b27f392f30e" },
																										{"RimLight","d52783133eb3d144cb449f9d886e0634" },
																										{"ScreenSpaceCurvature","ca4f0ee6d6a8ba64daf8e646ef287a6a" },
																										{"ScreenSpaceDetail","835b21104e8c1ca4f85b9df00fca695c" },
																										{"SimpleBlur","f33df407d9e2aaa4b8ed8aa9a6e4e724" },
																										{"SimpleGPUInstancing","68b3c2e8a08acdb419e89d8eaa4fb883" },
																										{"SimpleLambert","a3f926aae6ecf344491b1ce3a55645d4" },
																										{"SimpleRefraction","0d6d7ab52da9b594ca9ed1128f8dec63" },
																										{"SimpleTexture","185b2f580b1c09d49991d1b03ec0b4e0" },
																										{"SnowAccum","ac52aff10d15bf8499822f24a70aeee5" },
																										{"StencilDiffuse01","0e8ad59fc0e738c4d83e727176ea50d9" },
																										{"StencilMask01","2ec43c3998a29b6428cb75a66b54db37" },
																										{"StencilDiffuse02","c49a3aad8576f0646ad742078a3bcc22" },
																										{"StencilMask02","88b29ffc45d98c1459753c4b9c7c861c" },
																										{"StencilDiffuse03","f18818b02431b3046a17bf7b9d629d56" },
																										{"StencilMask03","a1d7f46880c369048b0e02e9e3342cc0" },
																										{"AnimatedRefraction","20fb4885fc87a4043a6d4b4a4ab72576" },
																										{"Tessellation","791dee6ce4b1f6a46922433884e3a731" },
																										{"Translucency","d6909e30fd813df40bdd9301d7d96ba4" },
																										{"Transmission","babd839f5efc0e543a855e20b7668b94" },
																										{"Transparency","521323deb7e76dd4d9df45339334b534" },
																										{"TriplanarProjection","32f7da5bdc31ad547ae350eaf31022eb" },
																										{"Ground","2df1e2de0d3e0904f8b943ac141f0aac" },
																										{"WaterSample","a9cde6543f2604b4cbd3023847cb9c0b" },
																										{"WorldPosSlices","f4e86bac65e56054bb81fc9d2d7d7960" }};
		...
		private static RectOffset PropertyPopUpBorder;
		private static RectOffset PropertyPopUpMargin;
		private static RectOffset PropertyPopUpOverflow;
		private static RectOffset PropertyPopUpPadding;

		public static void ForceExampleShaderCompilation()
		{
			CurrentWindow.ForceShadersToUpdate( ref m_exampleShaderIDs );
			//foreach ( KeyValuePair<string, string> kvp in m_exampleShaderIDs )
			//{
			//	Shader shader = AssetDatabase.LoadAssetAtPath<Shader>( AssetDatabase.GUIDToAssetPath( kvp.Value ) );
			//	if ( shader != null )
			//	{
			//		Debug.Log( "Recompiling " + shader.name );
			//		CurrentWindow.LoadDroppedObject( true, shader, null );
		...
		public static void InitMainSkin()
		{
			...
			PropertyPopUp = CustomStyle( AmplifyShaderEditor.CustomStyle.NodePropertyPicker );
			

			PlusStyle = new GUIStyle( ( GUIStyle ) "OL Plus" );
			PlusStyle.imagePosition = ImagePosition.ImageAbove;
			PlusStyle.alignment = TextAnchor.MiddleCenter;

			MinusStyle = new GUIStyle( ( GUIStyle ) "OL Minus" );
			MinusStyle.contentOffset = Vector2.zero;
			MinusStyle.imagePosition = ImagePosition.ImageAbove;
			MinusStyle.alignment = TextAnchor.MiddleCenter;
		...
		public static string TextureTypeToCgType( TextureType type )
		{
			return m_textureTypeToCgType[ type ];
		}
		...
		private static string CreateLocalValueName( PrecisionType precision, WirePortDataType dataType, string localOutputValue, string value )
		{
			return string.Format( Constants.LocalValueDecWithoutIdent, PrecisionWirePortToCgType( precision, dataType ), localOutputValue, value );
		}

		public static string CastPortType( MasterNodePortCategory portCategory, PrecisionType nodePrecision, NodeCastInfo castInfo, object value, WirePortDataType oldType, WirePortDataType newType, string parameterName = null )
		{
			...
			int castId = ( portCategory == MasterNodePortCategory.Vertex || portCategory == MasterNodePortCategory.Tessellation ) ? CurrentDataCollector.AvailableVertexTempId : CurrentDataCollector.AvailableFragTempId;
		...
		public static string GenerateUniformName( string dataType, string dataName )
		{
			return string.Format( Constants.UniformDec, dataType, dataName );
		}
		...
		public static bool HasColorCategory( string category )
		{
			return m_nodeCategoryToColor.ContainsKey( category );
		}
		...
		public static int TotalExampleShaders { get { return m_exampleShaderIDs.Count; } }
	}
}
