        ...
        public Vector3 TangentDirection
        {
            get
            {
                ...
                if ( OutputPorts[ 0 ].ConnectionCount > 0 )
                {
                    ...
                    otherInputPort = otherInputNode.GetInputPortById( OutputPorts[ 0 ].ExternalReferences[ 0 ].PortId );
                }
                ...
                if ( InputPorts[ 0 ].ConnectionCount > 0 )
                {
                    ...
                    otherOutputPort = otherOutputNode.GetOutputPortById( InputPorts[ 0 ].ExternalReferences[ 0 ].PortId );
                }
