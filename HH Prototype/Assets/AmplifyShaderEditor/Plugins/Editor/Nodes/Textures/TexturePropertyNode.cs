...
namespace AmplifyShaderEditor
{
	...
	public class TexturePropertyNode : PropertyNode
	{
		...
		protected void DrawTexturePicker( DrawInfo drawInfo )
		{
			...
			int fontSizeLower = m_buttonOverlay.fontSize;

			//cached values
			//int overflowTop = m_buttonOverlay.overflow.top;
			//int overflowLeft = m_buttonOverlay.overflow.left;

			//int borderTop = m_buttonOverlay.border.top;
			//int borderBottom = m_buttonOverlay.border.bottom;
			//int borderLeft = m_buttonOverlay.border.left;
			//int borderRight = m_buttonOverlay.border.right;
			...
			m_buttonOverlay.fontSize = ( int ) ( OriginalFontSizeLower * drawInfo.InvertedZoom );

			m_buttonOverlay.overflow.top = ( int ) ( -newRect.height + 15 * drawInfo.InvertedZoom );
			m_buttonOverlay.overflow.left = ( int ) ( -newRect.width + 75 * drawInfo.InvertedZoom );

			m_buttonOverlay.border.top = 0;
			m_buttonOverlay.border.bottom = 0;
			m_buttonOverlay.border.left = 5;
			m_buttonOverlay.border.right = 0;
			...
			m_buttonOverlay.fontSize = fontSizeLower;
